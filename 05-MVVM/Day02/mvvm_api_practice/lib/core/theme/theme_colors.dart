...
class LightThemeColors {
  static const Color primary = Color.fromARGB(255, 115, 6, 166); // Logo pink
  ...
  static const Color textDark = Color.fromARGB(255, 15, 14, 14);
...
class DarkThemeColors {
  static const Color primary = Color.fromARGB(255, 115, 6, 166); // Same as logo pink
